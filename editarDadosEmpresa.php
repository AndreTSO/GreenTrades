		    ...
		    <div class="content">
				...
				<div class="data">
					...
					<form  METHOD="POST" ACTION="ajax_fornecedor.php" name="registar">
						...
						<input id="contacto" name="contacto" type="text" pattern="\d{9}" value="<?php echo $resultado['contacto']; ?>" title="Numero de telefone com 9 digitos" required placeholder="">
						<br>
						...
						<input id="PeriodoXDiasCancelar" name="PeriodoXDiasCancelar" type="number" value="<?php echo $resultado['PeriodoXDiasCancelar']; ?>" required placeholder=""> dias
						<br>
