        ...
        <div class="page">
            ...
            <div class="content">
                ...
                <form ACTION = "ajax_fornecedor.php" METHOD = "POST">
                    ...
                    echo "<label><strong><em>Nome do Armazém:  &nbsp </em></strong></label><input type='text' name='nome' value = ''required placeholder='Nome do Armazem'><br>";
                    echo "<label><strong><em>Morada do Armazém:  &nbsp </em></strong></label> <input type='text' name='morada' value = ''required placeholder='Morada'><br>";
                    echo "<label><strong><em>Número Da Porta:  &nbsp </em></strong></label> <input type='number' name='nPorta' value = ''required'><br>";
                    echo "<label><strong><em>Número/Identificador do Armazém:  &nbsp </em></strong></label> <input type='text' name='andar' value = ''required ><br>";
                    ...
                    echo "<label><strong>Concelho</strong></label><input name='concelho' id='concelho' type='text' required placeholder='Escolha o distrito primeiro &#8593;' disabled><br>";
                    echo '</span>';
                    ...
                    echo "<label><strong><em>Custo de Manutenção do Armazém:  &nbsp </em></strong></label> <input type='number' name='custoManutencao' value = ''required><br>";
                    echo "<label><strong><em>Poluição gerada por este Armazém:  &nbsp </em></strong></label> <input type='number' name='poluicaoGerada' value = ''required ><br>";
                    
                    echo "<label><strong><em>Estado do Armazém:  &nbsp </em></strong></label>";
                    ...
                    echo "<input type='submit' value='Criar armazem' class='btnUser'> ";
