    ...
    <div class="page">
        ...
        <div class="content">
            <div class="data">
                ...
                echo "<label><strong><em>Nome Empresa:&nbsp</em></strong></label> <input type='text' name='nomeEmpresa' value = '' required placeholder='Nome da sua empresa'><br>";

                echo "<label><strong><em>Descrição:&nbsp</em></strong></label> <textarea name='descricao' required placeholder='Descreva um bocado a sua empresa' style='align-content: center;'></textarea><br>";
                echo "<hr>";
                ...
                echo "<label><strong><em>Categoria de produtos:&nbsp</em></strong></label> <input type='text' name='catProdutos' value = '' required placeholder='Descreva o que vai vender'><br>";
                ...
                echo "<label><strong><em>Dias para Cancelar a encomenda:&nbsp</em></strong></label> <input type='text' name='xDias' value = '' required placeholder='Coloque o seu website pessoal'><br>";
                echo "<input type='hidden' name='poluicaoGerada' value = '0' > ";
                echo "<input type='hidden' name='consumoRecursos' value = '0' >";
